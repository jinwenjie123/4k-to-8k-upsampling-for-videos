...
for i=1:9
img1 = imread(sprintf('D:/4k-to-8k/video1-png/LabFrames/bicubic/output_labbicubic00%d.png', i));
img2 = imread(sprintf('D:/4k-to-8k/video1-png/Ictcp/bicubic/output_ictcpbicubic00%d.png',i));
...
for i=10:99
img1 = imread(sprintf('D:/4k-to-8k/video1-png/LabFrames/bicubic/output_labbicubic0%d.png', i));
img2 = imread(sprintf('D:/4k-to-8k/video1-png/Ictcp/bicubic/output_ictcpbicubic0%d.png',i));
...
for i=100:400
img1 = imread(sprintf('D:/4k-to-8k/video1-png/LabFrames/bicubic/output_labbicubic%d.png', i));
img2 = imread(sprintf('D:/4k-to-8k/video1-png/Ictcp/bicubic/output_ictcpbicubic%d.png',i));
